    ...
    public CompanyPanel(){
        ...
        selectBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                new SelectDig(DataOnly.mainFrame);
        ...
        delBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(JOptionPane.showConfirmDialog(DataOnly.mainFrame, "是否要删除该条记录", "提示",
                    ...
                    JOptionPane.showMessageDialog(DataOnly.mainFrame, "请选中一条要删除的记录！！");
                }
            }
        });
        upPanel.add(delBtn);
